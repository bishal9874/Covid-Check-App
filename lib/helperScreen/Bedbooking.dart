...
import 'package:covidcheck/models/bedmodel.dart';
...
class BedBookingHisBook extends StatefulWidget {
  @override
  _BedBookingHisBookState createState() => _BedBookingHisBookState();
}

class _BedBookingHisBookState extends State<BedBookingHisBook> {
  @override
    ...
    return Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              ...
              .orderBy("bedreferID", descending: true)
              .snapshots(),
          builder: (context, dataShot) {
            if (!dataShot.hasData) {
              ...
              if (dataShot.data.docs.length == 0) {
                return Container(
                  child: Center(
                    child: Text("Your Bed Booking is Empty"),
                  ),
                );
              } else {
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    BedModel model =
                        BedModel.fromJson(dataShot.data.docs[index].data());
    ...
    return AppBar(
      ...
      title: Row(
        ...
        children: <Widget>[
          ...
          Text("Bed Booking", style: GoogleFonts.comfortaa(fontSize: 18.0)),
  ...
  Widget uservaccineinfo(BedModel model, BuildContext context,
                    ...
                    children: <TextSpan>[
                      TextSpan(
                          ...
                          style: GoogleFonts.comfortaa(
                              ...
                              color: Colors.white)),
                      TextSpan(
                          text: model.birthdate.toDate().toString(),
                          style: GoogleFonts.comfortaa(
                              fontWeight: FontWeight.w600,
                              color: Colors.orange[200])),
                    ],
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          width: width * 0.45,
                                          child: Text(
                                            "Are Your Sure !! You want to cancel your Booking Bed",
                                            style: GoogleFonts.comfortaa(
                                                fontSize: 17.0),
                                          ),
                                        ).centered(),
  ...
  removecart(String mod) {
    ...
    CovidCheckApp.firestore
        ...
        .doc(CovidCheckApp.sharedPreferences.getString(CovidCheckApp.userUID) +
            mod)
        .delete();
    VxToast.show(context, msg: "Bed Booking Deleted Successfully");
  }
}
